...
public interface MemberService {
    ...
    // java 1.8 : 인터페이스가 기본 메소드를 가질 수 있도록 함. 기본 메소드 : 반드시 만들어야 함, 형태도 정해져 있음.
    ...
    default  Member entityToDto(MemberEntity entity) {  // entity 캑체를 dto 객체로 변환 : service -> controller
